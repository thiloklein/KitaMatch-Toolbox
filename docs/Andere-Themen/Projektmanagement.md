...
Abbildung xy: Vorschlag eines Zeitplans
...
- Reflexion des bisherigen Verfahrens (IST)
- Formulieren des gewünschten Verfahrens (SOLL)
- Info und Legitimation durch Politik
- Info/Aufklärung und Sensibilisierung der Träger/Kitas
- Info an die Eltern
- Zeit für die Vor- und Nachbereitung
- klare und transparente Kommunikation unter den Beteiligten
- Offenheit für Fragen
- lösungsorientiertes, gemeinschaftliches Handeln 
  - Verantwortungsgemeinschaft
- Einhaltung des Datenschutzes
- Weitergehende Presse- und Öffentlichkeitsarbeit
  - Info im Rahmen politischer Sitzungen
  - Gespräch(e) mit den Trägern/Kitaleitungen
  - Elternbrief
  - Pressearbeit
  - erfahrene Kitaleitungen als AnsprechpartnerIn/Multiplikatoren einsetzen
- Sicherstellen von ausreichender Datenqualität
- Stetige Reflexion und ggfls. Optimierung.
...
Ein weiterer wichtiger Aspekt ist, dass die Beteiligten die Vorteile des Systems verstehen und das Matching für sich adaptieren (möchten). Sicherlich ist es auch von Vorteil, dass das algorithmusbasierte Verfahren schon seit Jahren in ähnlichen, sozialbildungspolitischen Bereichen (Vergabe der Studienplätze, …) Anwendung findet und immer mehr Kommunen dieses Verfahren erfolgreich einführen. Die konkreten Vorteile finden Sie in Kapitel xy. 
...
🡪 **Einverständnis aller Beteiligten ist zwingend erforderlich für eine erfolgreiche Umsetzung!**
...
Im Anschluss (Spätherbst) stellt die Projektleitung die Ausgangsliste (siehe Anlage xy), die die Kitaleitungen bzw. FB KTP mit den Daten ihrer angemeldeten Kinder ausgefüllt haben, zusammen. Diese Liste wird im Anschluss in Zusammenarbeit mit der IT-Fachkraft diese Ausgangsliste ins Kita-Match implementiert <mark>(siehe Kapitel 2.3.1.1. bzw. IT-Part)</mark>. Die jeweilige Kitaleitung/FB KTP hat sodann die Möglichkeit, ihre Bewerberliste im Kita-Match auf Vollständigkeit und Plausibilität zu prüfen <mark>(vgl. Kapitel 2.1.)</mark>. Diese Bewerberlisten beruhen auf dem zugrunde gelegten Kriterienkatalog und die entsprechend ermittelten Punktwerte pro Kind. Bei Punktgleichheit sortiert das Programm automatisch das ältere Kind einen Platz vor dem anderen (jüngeren) Kind.
