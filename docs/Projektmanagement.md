...
Ein weiterer wichtiger Aspekt ist, dass die Beteiligten die Vorteile des neuen Systems verstehen und das Matching für sich adaptieren möchten. Dabei ist es auch von Vorteil, dass das algorithmusbasierte Verfahren schon seit Jahren in ähnlichen, sozialbildungspolitischen Bereichen (z. B. Vergabe der Studienplätze) Anwendung findet und immer mehr Kommunen dieses Verfahrens erfolgreich einführen. Die konkreten Vorteile sind im Kapitel zum [Gale-Shapley Verfahren](/docs/Gale-Shapley-Verfahren/Stabilität-und-Strategie-Sicherheit) beschrieben. 
...
Das Matching kann auch online durchgeführt werden. Hierfür bedarf es aber sowohl technischer als auch [organisatorische Hilfestellung](/docs/Uebersicht-Software/Matching-Day#das-matching) (z.B. jeweils zwei Endgeräte für die Kitaleitungen, mit denen sie zur besseren Übersicht das Matching verfolgen bzw. das Matching-Tool bedienen können).
